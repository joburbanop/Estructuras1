...
public class Discotienda
{
    ...
    // -----------------------------------------------------------------
    // Metodos necesarios para el cumplimiento de los requerimientos funcionales solicitados
    // -----------------------------------------------------------------
    ...
    */
    ...
    /**
     * Generar un reporte de de todos los discos de un género ROCK y POP con precio menor a 1000
     * @return reporte exitoso si cumple las condiciones
     * @throws Exception - cuando los discos de Rock y pop no cumplen las condiciones
     */
    public String generarInformeDiscosEconomicosRockyPop()throws Exception
    {
        ...
        //crear la lapiz para escribir el archivo 
        PrintWriter lapiz=new PrintWriter(archivo2);

        //escribir con la lapiz en el archivo
        lapiz.println("Reporte de discos de genero pop o rock");
        lapiz.println("======================");
        ...
        for (int i = 0; i < discos.size(); i++) {
            ...
            if(miDisco.darGenero().equals("Rock") || miDisco.darGenero().equals("Pop"))
            {
                ...
                if (miDisco.darPrecioDisco()<=1000) {
                    DiscosQueCumplenLasCondiciones++;
                    //escribir con la lapiz la informacion requerida 
                    lapiz.println("Nombre: "+ miDisco.darNombreDisco()+"Artista: "+miDisco.darArtista()+"Genero: "+miDisco.darGenero()+"Precio: "+miDisco.darPrecioDisco());
                }
            }
        ...
        if (DiscosQueCumplenLasCondiciones==0) {
                
            throw new Exception("No se encontraron discos con esas condiciones");
        }
        else{
